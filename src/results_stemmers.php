...
<body class="bg-gray-50 text-gray-800 p-5">
    ...
    <!-- New Header Section -->
    <header class="mb-8">
        <h1 class="text-4xl font-extrabold text-green-700 mb-2">Verkiezingsresultaten</h1>
        <p class="text-lg text-gray-600">Bekijk de meest recente verkiezingsresultaten en statistieken.</p>
    </header>
